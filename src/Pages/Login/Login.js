                ...
                <Box>
                    <form onSubmit={formik.handleSubmit}>
                        <InputGroup size="lg" backgroundColor="gray.200" borderRadius="7px" marginBottom="4">
                            <InputLeftElement backgroundColor="gray.200" borderRight="1px" borderColor="gray.400" borderLeftRadius="7px" shadow="">
                                <svg style={{ width: "50px", height: "50px" }} width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M50.4207 58.6667C49.4522 55.6544 47.3179 52.9926 44.3489 51.0941C41.38 49.1957 37.7423 48.1666 34 48.1666C30.2577 48.1666 26.62 49.1957 23.6511 51.0941C20.6821 52.9926 18.5478 55.6544 17.5793 58.6667" stroke="#7D8790" strokeWidth="2" />
                                    <circle cx="34" cy="28.3334" r="8.5" stroke="#7D8790" strokeWidth="2" strokeLinecap="round" />
                                </svg>
                            </InputLeftElement>
                            <Input
                        ...
                        <InputGroup size="lg" backgroundColor="gray.200" borderRadius="7px" marginBottom="4">
                            <InputLeftElement backgroundColor="gray.200" borderRight="1px" borderColor="gray.400" borderLeftRadius="7px">
                                <svg style={{ width: "50px", height: "50px" }} width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="25.5" cy="39.6667" r="11.3333" stroke="#7D8790" />
                                    <path d="M34 31.1667L43.9167 21.25M48.1667 17L43.9167 21.25M43.9167 21.25L51 28.3333" stroke="#7D8790" strokeLinecap="round" />
                                </svg>
                            </InputLeftElement>
                            <Input
                                ...
                                required
                                id="password"
                                type={hidden ? "password" : "text"} placeholder='Password' marginLeft="3" />
                            <InputRightElement backgroundColor="gray.200" borderRightRadius="7px">
                                {
                                    hidden ?
                                        <svg onClick={() => {
                                            setHidden(!hidden)
                                        }} style={{ width: "50px", height: "35px", cursor: "pointer" }} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 15.5C13.933 15.5 15.5 13.933 15.5 12C15.5 10.067 13.933 8.5 12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 13.933 10.067 15.5 12 15.5Z" stroke="#222222" />
